				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-lg-8 ">
									<a href="/admin/demo/form" class="btn btn-primary"> <i
										class="fas fa-plus-square"></i> Thêm mới
									</a>
								</div>
								<div class="col-lg-4 mb-3">
									<form action="/admin/demo/list" method="post">
							...
							<table class="table table-bordered" width="100%" cellspacing="0">
								...
								<tbody>
									<c:forEach var="item" items="${demoItem.content}">
										<tr>
											<td>${location = location + 1}</td>
											<td>${item.tenloai}</td>
											<td>${item.mota}</td>
											<td>
												<a href="/admin/demo/list/load/${item.maloai}" class="btn btn-success">Sửa</a>
												<button type="button" class="btn btn-danger"
													data-toggle="modal" data-target="#exampleModal${item.maloai}">Xóa</button>				
											</td>
										</tr>
										<!-- Modal -->
										<div class="modal fade" id="exampleModal${item.maloai}"
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-body">Danh mục có tên là
														${item.tenloai} sẽ bị xóa vĩnh viễn khỏi hệ thống. Bạn có
														muốn tiếp tục?</div>
													<div class="modal-footer">
														<button type="button" class="btn btn-secondary"
															data-dismiss="modal">Đóng</button>
														<a
															href="/admin/demoForm/list/delete/${item.maloai}"
							...
							<nav aria-label="Page navigation example">
								<ul class="pagination justify-content-center">
									<li class="page-item ${(demoItem.number==0)?'disabled':''}"><a
										class="page-link"
										href="/admin/demo/list?p=${demoItem.number-1}"
										aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
									</a></li>
									<li class="page-item disabled"><a class="page-link"
										href="#">${demoItem.number+1}</a></li>
									<li
										class="page-item ${(demoItem.number>=demoItem.totalPages-1)?'disabled':''}"><a
										class="page-link"
										href="/admin/demo/list?p=${userItem.number+1}"
