			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<form:form action="/admin/demo/form" method="post"
								modelAttribute="loaisp" >
								
								<%-- <form:hidden path="maloai"/> --%>
								
								<div class="form-group">
									<label for="inputState">Tên loại</label>
									<form:input path="tenloai" cssClass="form-control"
										cssErrorClass="form-control is-invalid" id="inputEmail4" />
									<form:errors path="tenloai" cssClass="invalid-feedback"></form:errors>
								</div>
								...
								<div class="form-group">
									...
									<form:input path="mota" cssClass="form-control"
										cssErrorClass="form-control is-invalid" id="inputEmail4" />
									<form:errors path="mota" cssClass="invalid-feedback"></form:errors>
								</div>
...
<!-- 								<button type="submit" class="btn btn-primary">
								...
								<a href="/admin/demo/form" class="btn btn-info">
									<i class="fas fa-sync-alt"></i> Làm mới
								</a>
								
								<button formaction="/admin/demo/list" formmethod="get"
